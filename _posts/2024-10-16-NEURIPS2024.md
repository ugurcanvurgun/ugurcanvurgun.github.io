...
I will be presenting our research at the AIM-FM Workshop: Advancements In Medical Foundation Models, co-located with NeurIPS'24, to be held on December 14, 2024, at the Vancouver Convention Center.

<div style="text-align:center;">
    <a>
        <img src="/assets/images/NeurIPS2024_logo.png" alt="NeurIPS 2024" style="width:40%; height:auto;"/> <!-- Adjust width as needed -->
    </a>
</div>

## Presentation: Reliability in AI-Assisted Critical Care: Assessing Large Language Model Robustness and Instruction Following for Cardiac Arrest Identification

**Authors:**
- Ugurcan Vurgun: University of Pennsylvania
- Sy Hwang: University of Pennsylvania
- Sunil Thomas: University of Pennsylvania
- Ashley Batugo: University of Pennsylvania
- Ana Acevedo: University of Pennsylvania
- Aarthi Kaviyarasu: University of Pennsylvania
- Benjamin S. Abella: University of Pennsylvania
- Oscar J.L. Mitchell: University of Pennsylvania
- Danielle L. Mowery: University of Pennsylvania

In this study, we systematically evaluate the ability of large language models (LLMs) to accurately detect in-hospital cardiac arrest (IHCA) events using clinical data. Given the critical nature of IHCA detection, our goal was to assess not only the accuracy of these models but also their robustness across different datasets and their ability to consistently follow clinical instructions. We evaluated a total of 51 open-source models and used GPT-4 as a benchmark for performance comparison.
...
If you're interested in learning more about our study or would like to discuss potential collaborations, feel free to reach out.

<div style="text-align:center;">
    <a>
        <img src="/assets/images/error_rates.png" alt="Error Rates of Top Models" style="width:60%; height:auto;"/> <!-- Adjust width as needed -->
    </a>
</div>